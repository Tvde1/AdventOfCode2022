...
public class Day03 : IPuzzle<WireOperation[][], Day03Input>
{
    ...
    public static string Part1(WireOperation[][] input)
    {
    ...
    public static string Part2(WireOperation[][] input)
    {
